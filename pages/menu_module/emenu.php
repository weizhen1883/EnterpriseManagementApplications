      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav edit-actions-hidden">
            ...
            <li><a id="order-system" href="orderSystem.php"><?php echo $constantString['navbar']['order_system']; ?></a></li>
            <li><a id="staff-management" href="staffManagement.php"><?php echo $constantString['navbar']['staff_management']; ?></a></li>
          </ul>
          <!-- edit nav bar -->
